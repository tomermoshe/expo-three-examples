...
class MinecraftThree extends Component {
  scene: any;
  renderer: any;
  camera: any;
  renderLoop: any;
  ...
  onContextCreate = async ({ gl, scale: pixelRatio, width, height }) => {
    ...
    this.scene.background = new THREE.Color(0x3ac7ff);
    ...
    var texture = await ExpoTHREE.loadAsync(require('../../assets/textures/minecraft/atlas.png'));
...
export const Minecraft = withTouch(MinecraftThree);
